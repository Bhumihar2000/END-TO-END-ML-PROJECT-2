...
class KMeansClustering:
    ...
    def elbow_plot(self, data):
        """
                ...
                Output:- A picture savced to the directory
        ...
        try:
            ...
            self.logger_object.log(self.file_object, "The optimum number of clusters failed. Exited the elbow_plot method of the KMeansClustering class")
            raise Exception()
    ...
    def create_clusters(self, data, number_of_clusters):
        ...
        try:
            ...
            self.logger_object.log(self.file_object, "Fitting the data to cluster failed. Exited the create_clusters method of the KMeansClustering class")
            raise Exception()
