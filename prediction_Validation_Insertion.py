...
from Prediction_Raw_Data_Validation.predictDataValidation import Prediction_Data_validation
...
class pred_validation:
    ...
    def prediction_validation(self):
        try:
            ...
            #validating if any column has all value missing
            ...
            self.log_writer.log(self.file_object, " Moving Bad files to Archieve and deleting bad_data folder!!!")
