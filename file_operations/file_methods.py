...
class File_Operation:
    """
                This class shall be used to save the model after training and load the saved model foe prediction.
    ...
    def save_model(self, model, filename):
        ...
        try:
            ...
            self.logger_object.log(self.file_object, "Model File '+filename+' saved. Exited the save_model of the Model_Finder class")
            return 'success'
    ...
    def find_correct_model_file(self, cluster_number):
        """
                    ...
                    Description:- Select the correct modelbased on cluster number
        ...
        try:
            ...
            self.logger_object.log(self.file_object, "Exception Occured in find_correct_moedl_file method of the File_Operation class. Exception Message: " +str(e))
            self.logger_object.log(self.file_object, "Exited the find_correct_model_file method of the File_Operation class with failure")
            raise Exception()
